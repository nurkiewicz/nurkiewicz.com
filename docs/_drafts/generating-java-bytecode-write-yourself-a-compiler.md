...
000000e0: 07 50 4C 30 2E 70 6C 30 03 00 12 D6 87 03 49 96  .PL0.pl0......I.
000000f0: 02 D2 00 21 00 02 00 04 00 00 00 00 00 01 00 09  ...!............
00000100: 00 06 00 07 00 01 00 05 00 00 00 18 00 03 00 01  ................
00000110: 00 00 00 0C B2 00 0D 12 16 12 17 68 B6 00 13 B1  ...........h....
00000120: 00 00 00 00 00 01 00 14 00 00 00 02 00 15        ..............
```

The relevant part (our code) is barely this:

```
00000110: 00 00 00 0C B2 00 0D 12 16 12 17 68 B6 00 13 B1  ...........h....
```

Bytes `12 16 12 17 68` basically represent our entire program, the rest is just `.class` file ceremony:


```
3: ldc           #22                 // int 1234567
5: ldc           #23                 // int 1234567890
7: imul
```
